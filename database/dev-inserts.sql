...
INSERT INTO platforms (tfl_public_number, tfl_public_direction_name, train_direction, station_naptan, individual_stop_id) VALUES
  ...
  (1,'Eastbound','left','9400ZZLUWTA','9400ZZLUWTA1'), -- westacton
  (1,'Eastbound', 'left', '9400ZZLUOXC','9400ZZLUOXC1'), --oxford circus central
  (6,'Southbound', 'left', '9400ZZLUOXC', '9400ZZLUOXC6'), --oxford circus victoria
  (3,'Southbound', 'left', '9400ZZLUVIC', '9400ZZLUVIC3') --Victoria hmm needs thinking about for the terminii stations
  ;
