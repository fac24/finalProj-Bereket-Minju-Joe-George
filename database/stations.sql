...
('940GZZLUERB', 'Edgware Road (Bakerloo Line) Underground Station'),
...
('940GZZLUPAH', 'Paddington (H&C Line) Underground Station'),
...
('940GZZLUSBC', 'Shepherd''s Bush (Central Line) Underground Stn'),
